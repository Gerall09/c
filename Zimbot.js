// ⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈
//▮WhanSaff 2022 ®️ALL RIGHTS RESERVED
//▮
...
❲ *_ʀᴘɢ ɢᴀᴍᴇ_* ❳`
  ...
  .catch ((err) => reply(err))
          ...
          const emote = (satu, dua) => {
            ...
            const buttonMessage = {image: {url: emoji.images[dua].url},caption: "WhanSaff",footerText: 'Loading...',buttons: buttons,headerType: 4}
...
if (!isBotAdmins) return reply('*Lu Admin Kocak*')
reply(`*▊▊▊ ANTIYT ▊▊▊*\n\n* Mampus Lu Kalo Mau Share Yt Izin Dlu Ngentod, Hohohoho*`)
if (isAdmins) return reply(`*Ehh sorry you admin*`)
 if (isCreator) return reply(`*Minta Maap Ama Om Gerall*`)
kice = m.sender
...
ZimBotInc.sendMessage(m.chat, {text:`*▊▊▊ ANTILINK ▊▊▊*\n\n@${kice.split("@")[0]} *Mampus Lu Kalo Mau Share Yt Izin Dlu Ngentod, Hohohoho*`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
}
}
...
reply(`*▊▊▊ ANTIBULE ▊▊▊*\n\n*Sorry WhanSaff will kick you out because you are a stranger in this group*`)
if (isAdmins) return reply(`*Ehh sorry you admin*`)
if (isCreator) return reply(`*whoa you are  bot creator i wont kick you okay*`)
kice = m.sender
await ZimBotInc.groupParticipantsUpdate(m.chat, [kice], 'remove').then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
...
setTimeout(function(){
  ZimBotInc.sendMessage(ZimBotInc.user.id, {text: `*WhanSaff ANNOUNCEMENT:* *Instagram TO Rall_Nation*\n\n*IG:* https://www.Instagram.com/rall_nation09\n\n*Follow Gak Anj*\n\n*FEEL FREE TO BRING IDEAS OF THE FEATURES ON THE TABLE*\n\n*Siiiuuuuuuu*`,contextInfo: { externalAdReply:{title:"Kyaaahhhh",body:"Instagram Rall_Nation09",showAdAttribution: true,mediaType:2,thumbnail: fs.readFileSync(`./drips.jpg`) ,mediaUrl:`https://youtu.co/c/AlmGrll`, sourceUrl: `https://youtu.co/c/AlmGrll` }}}, {quoted: m})
...
switch(command) {
  case 'quest':
    ...
    ZimBotInc.sendList(m.chat, `Hi Chomie *${pushname}*`, `Please Select Below`, "CLICK", "ʀᴘɢ ɢᴀᴍᴇ   ", sectionnya, { quoted: m})
    break
    case 'slime':
    case 'killslime':
...
var button = [
        ...
        ZimBotInc.sendMessage(from, { caption: hg, location: { jpegThumbnail: cing }, templateButtons: button, footer: `ʀᴘɢ ɢᴀᴍᴇ `, mentions: [sender] })
...
var button = [
        ...
        var hg = `「 DEATH 」\n\n *┊ Place*  ${ad}\n ┊ *MONEY :* $${money}\n ┊ *EXP :* ${adven}Xp`
        ZimBotInc.sendMessage(from, { caption: hg, location: { jpegThumbnail: hasm }, templateButtons: button, footer: `ʀᴘɢ ɢᴀᴍᴇ  `, mentions: [sender] })
        .catch ((err) => reply(mess.error))
}, 7000)
setTimeout( () => {
...
Please @${m.mentionedJid[0].split`@`[0]} to type accept/reject`
 ...
 break
  /*  case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
   ZimBotInc.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/9960f328be97230d411ad.jpg' }, caption: `*𝗛𝗜 𝗕𝗥𝗢 ${m.pushName}*\n\n Donasi Broh Biar Berkah \n 250rands Per Group via Gpay\n\nNeh Chat Owner Nya \nhttps://wa.me/6282196995322 (Gerall OWNER)\n\n𝗗𝗢𝗡𝗔𝗧𝗘 : \n\n 𝗣𝗔𝗬 : https://saweria.co/Gerall\n` }, { quoted: m })
 }
 */
 break
 case 'sc': case 'script': case 'donate': case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
  ...
  teks = `
  *WhanSaff*\n\n*YOUTUBE:* https://Instagram.com/rall_nation09\n*Website:* https://biodata.gerallrall.repl.co\n\n*DONATE:* https://www.paypal.com/paypalme/zimbotinc`
  let buttons = [
  ...
  sourceUrl: "https://Instagram.com/rall_nation09g"
  }}
  }
  ZimBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
  }
...
await ZimBotInc.sendButtonText(m.chat, drips, `*▊▊▊ANTILINK VIEW▊▊▊*`, `WhanSaff`, m)
}
break
...
await ZimBotInc.sendButtonText(m.chat, button, `*▊▊▊HORNY MOOD▊▊▊*\n\n*TURN IT ON SO PEOPLE THEY WILL START TO MASTURBATE LOL*`, `WhanSaff`, m)
}
}
break
 case 'ephemeral': {
...
if (!regex1.test(args[0])) throw 'link!'
   let [, user, repo] = args[0].match(regex1) || []
    ...
    ZimBotInc.sendMessage(m.chat, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' , quoted: m,contextInfo: { externalAdReply:{
      ...
      thumbnail: fs.readFileSync('./drips.jpg'),
      mediaUrl:`https://Instagram.com/rall_nation09`, 
      sourceUrl: `https://Instagram.com/rall_nation09`,
      }}
      })
 ...
 case 'truth':
        ...
        thumbnail: fs.readFileSync(`./drips.jpg`) ,
        mediaUrl:`https://Instagram.com/rall_nation09`, 
        sourceUrl: `https://Instagram.com/rall_nation09` }}}, {quoted: m})
break
case 'ghsearch': 
       case 'Websitesearch': 
       case 'searchWebsite':
...
if(i.url.includes('mp4')){
let link = await getBuffer(i.url)
ZimBotInc.sendMessage(m.chat, { video: link, jpegThumbnail: await getBuffer(i.thumbnail), caption: `*WhanSaff*` }, { quoted: m }) 
} else {
let link = await getBuffer(i.url)
ZimBotInc.sendMessage(m.chat, { image: link, jpegThumbnail: await getBuffer(i.thumbnail), caption: `*WhanSaff*` }, { quoted: m })                  
}
}
...
ZimBotInc.sendMessage(m.chat, { video: { url: i.url }, jpegThumbnail:buf, caption: `WhanSaff`}, { quoted: m }).catch((err) => m.reply('error'))
}
}
break
case 'igimage': {	            
...
ZimBotInc.sendMessage(m.chat, { video: { url: i.url }, jpegThumbnail:tummb, caption: `*WhanSaff*`}, { quoted: m }).catch((err) => m.reply('*Sorry, the feature is in error*'))
}
}
break
...
ZimBotInc.sendMessage(m.chat, { video: { url: data[0].url }, jpegThumbnail:buf, caption: `WhanSaff`}, { quoted: m })
}).catch((err) => {
reply(`*Failed to download media and send videos*`)
})
}
...
let txt = `「 *ZIMBOT BROADCAST* 」\n\n${text}`
ZimBotInc.send5ButImg(i, txt, WhanSaff, global.bc, btn)
}
...
let txt = `「 *ZIMBOT BROADCAST* 」\n\n${text}`
ZimBotInc.send5ButImg(yoi, txt, WhanSaff, global.bc, btn)
}
...
ZimBotInc.sendMessage(yoi, { caption: `${melo}`, location: { jpegThumbnail: await getBuffer(picak+'Brodcast') }, buttons: button, footer: `WhanSaff`, mentions: [m.sender] })
}		
}
break
...
ZimBotInc.send5ButImg(i, junn, `WhanSaff`, buffer, butoon)
} else if (/video/.test(mime)) {
...
//let ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "6289523258649-1604595598@g.us"}, "message": {orderMessage: {itemCount: 666666666,status: 200, thumbnail: await getBuffer(picak+'Brodcast'), surface: 200, message: `© WhanSaff`, orderTitle: 'memek', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
let ftroli = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `6283136505591-1614953337@g.us` } : {}) }, message: { 'contactMessage': { 'displayName': `© WhanSaff`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${ZimBotInc.user.name},;;;\nFN:WhanSaff,\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': await getBuffer(picak+'Brodcast'), thumbnail: await getBuffer(picak+'Brodcast'),sendEphemeral: true}}}
let anu = await store.chats.all().map(v => v.id)
...
ZimBotInc.sendMessage(m.chat, { image: { url: anu }, caption: `Made by WhanSaff` ,  quoted: m, contextInfo: { externalAdReply:{
  title:"WhanSaff",
  body:"Instagram WhanSaff",
  showAdAttribution: true,
  mediaType:2,
...
// https://hardianto.xyz/api/beta/hacker2?apikey=hardianto&pp=https://i.ibb.co/1s8T3sY/48f7ce63c7aa.jpg
  ...
  ZimBotInc.sendMessage(m.chat, { image: dri,caption:'WhanSaff' }, { quoted: m})
...
let buttons = [
              ...
              let buttonMessage = {
                  ...
                  footer: `Bot Created by Geral Stampan`,
                  buttons: buttons,
                  headerType: 4
              }
              ZimBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
...
let buttons = [
              ...
              let buttonMessage = {
                  ...
                  footer: `Bot Created by Gerall Stampan`,
                  buttons: buttons,
                  headerType: 4
              }
              ZimBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
...
{ buttonId: 'stop', buttonText: { displayText: 'STOP' }, type: 1 }
  ...
  await ZimBotInc.sendButtonText(m.chat, buttons, `_You Are Still In Anonymous Session, WhanSaff To Terminate Your Anonymous Session_`, ZimBotInc.user.name, m)
  throw false
   }
...
%readmore` 
    ...
    const buttonsDefault = [{ urlButton: { displayText: `Instagram`, url : `https://www.Instagram.com/rall_nation09` } }, { urlButton: { displayText: `Website`, url : `https://biodata.gerallrall.repl.co` } },
    {					
      quickReplyButton: {
      displayText: 'SPEED',
      id: 'ping'
    ...
    sourceUrl: `https://Instagram.com/rall_nation09`
      ...
      ZimBotInc.send5ButMsg(m.chat, anu, WhanSaff, btn)
